  ...
  return (
      ...
      <div className="w-auto mx-auto flex flex-col items-center mb-8 ">
       ...
       <button type="button" className="bg-black text-white px-5 py-2 text-sm rounded-3xl">Shop Air Max</button>
        ...
        {/*cards*/}
         <div className='w-[94%] pb-14 mx-auto'>
          {/* 01 */}
          <div className='flex justify-between items-center'> 
          <div className='ml-4 text-xl font-semibold'><p>Best of Air Max</p></div>
           
           <div className='flex py-2 gap-2 items-center'>
           <div className='text-sm mr-8 font-semibold ns:mr-0'><p>Shop</p></div>
           <div className='hidden ns:block bg-gray-100 p-1 rounded-full'><Image className="" src='/images/back48.png' alt='photo' width={20} height={15}/></div>
           <div className='hidden ns:block bg-gray-100 p-1 rounded-full'><Image className="" src='/images/more48.png' alt='photo' width={20} height={15}/></div>
          </div>
          </div>
          
          {/* 02 */}
          <div className='flex flex-col gap-14 ns:flex-row ns:gap-1 sm:gap-2 md:gap-4'>
            {/* cart-1 */}
          <div className='w-[92%] h-[260] mx-auto ns:w-4/12 ns:h-[200] sm:w-4/12 sm:h-[230] md:h-[280] lg:h-[340] 2xl:h-[420]'>
          <Image className="w-full h-full" src='/images/boot1.png' alt='photo' width={500} height={300}/>
          ...
          {/* cart-2 */}
          <div  className='hidden w-[92%] h-[260] mx-auto ns:block ns:w-4/12 ns:h-[200] sm:w-4/12 sm:h-[230] md:h-[280] lg:h-[340] 2xl:h-[420]'>
          <Image className="w-full h-full" src='/images/boot2.png' alt='photo' width={500} height={300}/>
          <div className='text-xs ml-1 mt-2 sm:ml-0 md:text-sm font-semibold'>
          <div className='flex justify-between ns:flex-col sm:flex-row sm:justify-between'>
            <p>Nike Air Max 97 SE</p>
            <p>Rs. 16995</p>
          ...
          {/* cart-3 */}
          <div  className='w-[92%] h-[260] mx-auto ns:w-4/12 ns:h-[200] sm:h-[230] md:h-[280] lg:h-[340] 2xl:h-[420]'>
          <Image className="w-full h-full" src='/images/boot3.png' alt='photo' width={500} height={300}/>
          <div className='text-xs ml-1 mt-2 sm:ml-0 md:text-sm font-semibold'>
          <div className='flex justify-between ns:flex-col sm:flex-row sm:justify-between'>
            <p>Nike Air Max 97 SE</p>
            <p>Rs. 16995</p>
