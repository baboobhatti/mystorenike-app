    ...
    <>
      ...
      <div className='flex justify-between items-center'>
          ...
          <div className='flex py-2 gap-2 items-center mr-1'>
            ...
            <div className='hidden ns:flex bg-gray-100 p-1 rounded-full'><Image className="" src='/images/back48.png' alt='photo' width={10} height={10} /></div>
            <div className='hidden ns:flex bg-gray-200 p-1 rounded-full'><Image className="" src='/images/more48.png' alt='photo' width={10} height={10} /></div>
          </div>
        </div>
