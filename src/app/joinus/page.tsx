...
const login = () => {
  return (
      <>
    <div className='w-[98%] sm:w-[380]  mx-auto mb-44 mt-6'>
      <div className=''>
      ...
      <div>
        <form className='mt-4' action="">
            ...
            <input className='block border-2 w-[280] pl-4 py-1 mx-auto mb-4 rounded' type="password" placeholder='Password' />
            <input className='block border-2 w-[280] pl-4 py-1 mx-auto mb-4 rounded' type="email" placeholder='First Name' />
            <input className='block border-2 w-[280] pl-4 py-1 mx-auto mb-4 rounded' type="password" placeholder='Last Name' />
            <input className='block border-2 w-[280] pl-4 py-1 mx-auto mb-4 rounded' type="password" placeholder='DOB' />

            <select className='block border-2 w-[280] pl-4 py-1 mx-auto mb-4 rounded' name="country">
